 ...
 *
 * You can use this method to integrate with other libraries that expect a
 * function that takes a node style callback as its parameter. Example of such
 * libraries are promise libraries.
 *
 * You might want to chain `pull` after a [`collect`](#collect) too send all
 * values to the node style callback, and to end the stream.
 *
 * It is used internally by some functions in the Highland library.
 *
 * @id pull
 * @section Consumption
 * @name Stream.pull(f)
 ...
 * });
 *
 * // Creating a promise with all the values using Q
 * q.ninvoke(xs.collect(), "pull")
