...
/**
 * Creates a stream that ends immediately. Behaves as the identity for [concat](#concat)
 *
 * @id empty
 * @name empty()
 * @section Utils
...
/**
 * An alias for the [flatMap](#flatMap) method.
 *
 * @id chain
 * @section Higher-order Streams
 * @name Stream.chain(f)
 ...
 * @api public
 *
 * filenames.chain(readFile)
 */

Stream.prototype.chain = Stream.prototype.flatMap;
_.chain = _.flatMap;

/**
 * Create a new Stream of values by applying each function in a Stream to
 * each item in a Stream of values.
 *
 * @id ap
 * @section Higher-order Streams
 * @name Stream.ap(m)
 * @param {Stream} m - the stream of values to transform
 * @api public
 *
 * operations.ap(filenames)
 */

Stream.prototype.ap = function(m) {
