 ...
 * data event. The data will be passed in a sorted order. The method for
 * sorting the elements is ascending lexical by default. If required, a
 * custom sorting function can be passed as first parameter.
 *
 * This is a bit like doing [toArray](#toArray), but instead
 ...
 * @api public
 *
 * var sorts = _([3, 1, 4, 2]).sort(function (a, b) {
 *     var direction = 0;
 *
 *     if(a > b ) direction = -1;
...
Stream.prototype.sort = function (s) {
    var params = [];
    ...
    return this.collect().invoke('sort', params).sequence();
};
exposeMethod('sort');
