...
Stream.prototype._runGenerator = function () {
    ...
    do {
        ...
        this._generator.call(this, this._push_fn, this._next_fn);
...
Stream.prototype.consume = function (f) {
    ...
    this._consumer = new ConsumeStream(this, f);
    this._consumer.onDestroy(this.destroy.bind(this));
...
function ConsumeStream(source, f) {
    ...
    function pullCb(err, x) {
        ...
        if (self._defer_run_generator) {
            ...
            if (self._run_generator_deferred) {
                self._runGenerator();
            }
        }
    }
