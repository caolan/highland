...
* Async Iterator/Iterable support - Async iterators and iterables (as defined by the [Async Iteration
  specs](https://tc39.es/proposal-async-iteration/)), can now be passed to the Highland constructor function.
